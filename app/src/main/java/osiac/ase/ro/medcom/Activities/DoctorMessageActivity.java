...
public class DoctorMessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_view_doctor_message);
        ...
        mReferenceName = FirebaseDatabase.getInstance().getReference("Patients");
        ...
        mReferenceMessages.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    adapter = new MessageAdapter(DoctorMessageActivity.this,messages);
